...
class AboutSymbols < Neo::Koan
  ...
  # Answer: because comparing against a symbol creates it!
  # Symbol.all_symbols.find { |x| x == :test_method_names_become_symbols }
  ...
  # because they won't be GCed? they are as of ruby 2.2.0 apparently
  # https://stackoverflow.com/a/26043224
end
