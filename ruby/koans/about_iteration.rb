...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject is an alias for reduce! it applies a 2-arg function to each element
    # and the previous result. the return value becomes the next 'previous result'.
    # if no initial value is supplied, the first element is used.
  end
  ...
  # I'd guess that using the block the file is automatically closed at the end.
