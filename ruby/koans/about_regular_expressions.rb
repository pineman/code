...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # They return the longest match possible. For example /ab*/ in "abbcccddddeeeee"
  # matches 'ab' and 'abb', but since * is greedy it returns 'abb'.
  ...
  # from here: https://github.com/nathantypanski/ruby-koans/blob/8c502ada45577c836d66df6ceddf4bbd6b1d6457/about_regular_expressions.rb#L157
  # character classes [...] make (most) characters inside literal; for example,
  # the dot is literally a dot inside [.], and no longer 'any character except \n'.
  # alternation works for whole regexes, so it's much more like a logical OR
